  ...
  return (
    ...
    >
      <div className="grid gap-5 md:grid-cols-2">
        ...
        <label className="space-y-2 md:col-span-2">
          ...
          <input
            ...
            name="businessName"
            className="w-full rounded-2xl border border-neutral-200 bg-white px-4 py-4 outline-none transition focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100"
            placeholder="Your business or acquisition entity"
          />
        </label>
        ...
        <label className="space-y-2 md:col-span-2">
          ...
          <textarea
            ...
            placeholder="Savings, home equity, 401K/IRA, stocks/bonds, real estate, or other sources"
          />
        </label>
        <label className="space-y-2 md:col-span-2">
          <span className="text-sm font-bold text-neutral-700">
          ...
          <input
            ...
            name="minimumIncome"
            className="w-full rounded-2xl border border-neutral-200 bg-white px-4 py-4 outline-none transition focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100"
            placeholder="Minimum income need"
          />
        </label>
        <label className="space-y-2 md:col-span-2">
          <span className="text-sm font-bold text-neutral-700">
      ...
      <div className="mt-5 flex items-center gap-3 rounded-2xl bg-emerald-50 p-4 text-sm font-semibold text-emerald-800">
        ...
        Buyer criteria and financial information are handled confidentially.
      </div>
      ...
      >
        Submit Buyer Registration <ArrowRight className="h-4 w-4" />
      </button>

      {submitted && (
        <div className="mt-5 flex items-center gap-3 rounded-2xl bg-emerald-50 p-4 text-sm font-semibold text-emerald-800">
          <CheckCircle2 className="h-5 w-5" />
          Thank you. Your buyer registration has been received.
        </div>
      )}
    </form>
  );
